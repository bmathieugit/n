...
void test_variant_default_constructor() {
  n::variant<int, double, n::string_iterator<const char>> v;
...
void test_variant_set_string_view() {
  n::variant<int, double, n::string_iterator<const char>> v;
  v.set(n::string_iterator<const char>("test"));
  N_TEST_ASSERT_FALSE(v.empty());
  // N_TEST_ASSERT_EQUALS(v.get<n::string_iterator<const char>>(),
  // n::string_iterator<const char>("test"));
}

void test_variant_copy_constructor() {
  n::variant<int, double, n::string_iterator<const char>> v1;
  v1.set(42);
  n::variant<int, double, n::string_iterator<const char>> v2(v1);
...
void test_variant_copy_assignment() {
  n::variant<int, double, n::string_iterator<const char>> v1;
  v1.set(42);
  n::variant<int, double, n::string_iterator<const char>> v2;
  v2 = v1;
  N_TEST_ASSERT_FALSE(v2.empty());
  N_TEST_ASSERT_EQUALS(v2.get<int>(), 42);
}
...
void test_variant_move_constructor() {
  n::variant<int, double, n::string_iterator<const char>> v1;
  v1.set(42);
  n::variant<int, double, n::string_iterator<const char>> v2(n::transfer(v1));
  N_TEST_ASSERT_FALSE(v2.empty());
  N_TEST_ASSERT_EQUALS(v2.get<int>(), 42);
}
